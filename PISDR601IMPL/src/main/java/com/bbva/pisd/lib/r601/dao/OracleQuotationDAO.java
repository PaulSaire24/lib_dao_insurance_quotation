...
import com.bbva.pisd.lib.r601.transfor.bean.QuotationTransforBean;
import com.bbva.pisd.lib.r601.transfor.map.QuotationTransforMap;
...
public class OracleQuotationDAO implements QuotationDAO {
    ...
    @Override
    public QuotationEntity findQuotationByPolicyQuotaInternalId(String policyQuotaInternalId) {
